...
Revision ID: 3f76e9eeaa7a
Revises: 
Create Date: 2024-07-29 17:55:38.333142
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('🚶 Olib ketish', '🚚 Dostavka', name='order_type'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('quantity', sa.Integer(), nullable=True),
    sa.Column('which_filial', sa.Integer(), nullable=True),
    sa.Column('where_to', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['number_id'], ['order_abouts.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['which_filial'], ['filials.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
